...
This is example code to go along with [this reddit](https://old.reddit.com/r/reactjs/comments/9kq8v6/beginners_thread_easy_questions_october_2018/e7ppp62/) post on how to test button clicks.  There is also a [CodeSandbox](https://codesandbox.io/s/github/qubitrenegade/react-button-test) example.

You should be able to check this repo out and run `yarn test`

### Default `create-react-app` documentation follows.
----------------------------------
